//코드7-11 자바파일 RecyclerViewAdapter.java
...
public class RecyclerViewAdapter extends Adapter<RecyclerViewAdapater.ViewHolder> {
	...
	@Override
	public void onBindViewHolder(final ViewHolder holder, fianl int position) {
